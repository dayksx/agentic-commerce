  ...
  return (
    <div className="relative overflow-hidden rounded-[32px] p-8 text-white shadow-[0_20px_40px_-10px_rgba(45,43,66,0.05)]">
      ...
      <div className="relative z-10 flex justify-between items-start">
        ...
        <div className="px-3 py-1 rounded-full bg-white/20 backdrop-blur-md text-xs font-bold tracking-wide">
      ...
      <div className="relative z-10 mt-8">
        ...
        <h3 className="text-4xl font-bold tracking-tight">
          {TREASURY_DATA.balance.toLocaleString("en-US", { minimumFractionDigits: 2 })}
